...
public class _Repository {
  ...
  public RegisterTemplateRepository  template()         { return _RegisterTemplateRepository; }
  public ModbusDeviceRepository      device()           { return _ModbusDeviceRepository; }
  public RegisterLocatorRepository   locator()          { return _RegisterLocatorRepository; }
}